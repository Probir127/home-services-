    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Ditt namn"}
            ),
            "email": forms.EmailInput(
                attrs={"class": "form-input", "placeholder": "Din e-post"}
            ),
            "phone": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Ditt telefonnummer"}
            ),
            "service_type": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Typ av tjänst"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "subject": forms.TextInput(
                attrs={"class": "form-input", "placeholder": "Ämne"}
            ),
            "message": forms.Textarea(
                attrs={
                    "class": "form-textarea",
