...
urlpatterns = [
    ...
    path('services/<str:category>/', views.ServiceListView.as_view(), name='api-services-category'),
    path('services/<str:category>/<slug:slug>/', views.ServiceDetailView.as_view(), name='api-service-detail'),
    path('pricing/', views.PricingPackageView.as_view(), name='api-pricing'),
    path('quote-request/', views.QuoteRequestCreateView.as_view(), name='api-quote-request'),
